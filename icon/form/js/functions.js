...
export function renderFormRegistrations(allFormClass) {
  ...
  <h2 class="lead__subtitle">
                  Petrol hisseleri ile istikrarlı gelecek programa katılım için
                  bir başvuru bırakın
                </h2>
 <div class="form-group input-group ">
    <input class="form-control form-input form__input" name="name" placeholder="Adınız"  type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve/veya sayıları kaldırın <br>- Uzay boş olamaz <br> - Ad ve soyad eşleşemez</span>
    <i class="fa__checked"></i>
</div>
  <div class="form-group input-group ">
    <input class="form-control  form-input form__input" name="last_name" placeholder="Soy adınız"  type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve/veya sayıları kaldırın <br>- Uzay boş olamaz <br> - Ad ve soyad eşleşemez</span>
    <i class="fa__checked"></i>
  </div>
  ...
  <h6>
                  Dikkat! Yönticimiz sizi yurt dışı numarasından arayacaktır.
                  Anlayışınız için çok teşekkür ederiz
                </h6>

  <div class="form-group" style="text-align: left; margin-bottom: 5px">
    <div style="display: flex; align-items: center;">
        <input style="height: 16px; width:16px; padding: 0;" type="checkbox" class="form-check-input" name="age_check1" required>
        <p class="text-muted" style="margin-left: 5px; font-size: 16px; margin-bottom: 0">Gizlilik Politikasını kabul ediyorum</p>
    </div>
   ...
   <div class="form-group" style="text-align: left;">
    <div style="display: flex; align-items: center;">
        <input style="height: 16px; width:16px; padding:0" type="checkbox" class="form-check-input" name="age_check" required>
        <p class="text-muted" style="margin-left: 5px; font-size: 16px; margin-bottom: 5px">18 yaşın üzerindeyim</p>
    </div>
  ...
  <div class="form-group">
    ...
    <button class="btn secondary-solid-btn btn-block buttonSend btn-danger"  name="submitBtn" type="submit">
    <p class="btnFormText" style="color:white; font-weight: 800;">ücretsiz kayıt
    </p>
    </button>
  </div>
