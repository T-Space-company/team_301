...
<html lang="en">
  ...
  <body>
    <main class="main">
      <!--------- SCREEN 1 --------->
      <div class="main__intro" id="first-screen">
        <img src="./assets/img/logo.svg" alt="Icon" />
        <div class="intro__content">
          <h1 class="intro__heading">Дарим акции каждый день</h1>
          <div class="intro__text">
            <p>
              <b>Успейте заработать</b> как можно больше в газпроминвест
              <b>сегодня!</b>
            </p>
            <p>Выходите на <b>пассивный доход от 150 000</b> рублей в месяц</p>
          </div>
          <button type="button" class="intro__button" id="start-btn">
            Забрать акции <img src="./assets/img/arrow.svg" alt="Icon" />
          </button>
        </div>
      </div>
      <!--------- SCREEN 2 --------->
      <div class="main__choose hidden" id="second-screen">
        <img src="./assets/img/main.png" alt="Image" class="choose__image" />
        <div class="choose__content">
          <p class="choose__heading">
            Выберите 1 из 3-х подарков и получите шанс забрать подарок в виде
            акций на сумму до
          </p>
          <span class="choose__sum">50 000 рублей</span>
        </div>
        <div class="choose__items animate">
          <div class="choose__item-wrap">
            <div class="choose__item">
              <img src="./assets/img/logo__item.svg" alt="Icon" />
              <img src="./assets/img/gift.png" alt="Icon" class="item__gift" />
            </div>
          </div>
          <div class="choose__item-wrap">
            <div class="choose__item">
      ...
      <!--------- SCREEN 3 --------->
      <div class="main__prize hidden" id="third-screen">
        <div class="prize__wrapper">
          <div class="prize__item-wrap">
            <div class="prize__item">
              <img src="./assets/img/logo__item.svg" alt="Icon" />
              <img src="./assets/img/gift.png" alt="Icon" class="item__gift" />
            </div>
          </div>
          <span class="prize__heading">Поздравляем!</span>
          <p class="prize__text">
            Вы выиграли <b>25 акций</b> на сумму <b>17 500 рублей!</b>
          </p>
          <button type="button" class="prize__button" id="prize-btn">
            Забрать акции <img src="./assets/img/arrow.svg" alt="Icon" />
          </button>
        </div>
      </div>
      <!--------- FORM SCREEN --------->
      <div class="main__last hidden" id="form-screen">
        <img src="./assets/img/logo.svg" alt="Icon" />
