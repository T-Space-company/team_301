...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control form-input form__input" name="name" placeholder="ADINIZ" required type="text" />
    <i class="fa__err"></i>
  ...
  <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control  form-input form__input" name="last_name" placeholder="SOYADI" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve/veya sayıları kaldırın <br>- Uzay boş olamaz <br> - Ad ve soyad eşleşemez</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
  ...
  <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control form-input _phone"  name="phone" type="tel" style="width: 100%" placeholder="501 234 56 78" required/>
    <span class="focus-input100"></span>
  </div>
  ...
  <div class="form-group container-login100-form-btn">
    <button class="btn secondary-solid-btn btn-block buttonSend login100-form-btn" style="background-color: #0056a5;" name="submitBtn" type="submit">
    <p class="leadSubmit buttonSend button form__btn btnFormText" style="color: #fff; text-transform: uppercase;">Kayıt
    </p>
    </button>
  </div>
  ...
  <div class="form-bottom">
              <span>Seviye IIl savunma:</span>
              <img src="./photos/icons.png" alt="Icons">
          </div>
