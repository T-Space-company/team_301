...
export function renderFormRegistrations(allFormClass) {
  ...
  const htmlFormHtml = `
<h2 class="form_title">
                    ОСТАВЬТЕ СВОИ КОНТАКТНЫЕ ДАННЫЕ И ПОЛУЧИТЕ УЖЕ ЗАВТРА СВОЮ ПЕРВУЮ ПРИБЫЛЬ, НЕ ВЫХОДЯ ИЗ ДОМА
                </h2>
 <div class="form-group input-group ">
    <input class="input-all form-control form-input form__input" name="name" placeholder="Имя"  type="text" required />
    <i class="fa__err"></i>
  ...
  <div class="form-group input-group ">
    <input class="input-all form-control  form-input form__input" name="last_name" placeholder="Фамилия" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Удалите пробелы и/или цифры <br>- Поле не может быть пустым <br> - Имя и фамилия не должны совпадать</span>
    <i class="fa__checked"></i>
    </div>
  ...
  <div class="form-group input-group" style="margin: 10px 0;">
    <input class="input-all form-control form-input _phone" maxlength="10" placeholder="9121234567" name="phone" type="tel" />
 ...
 <div style="margin-top: 10px;" class="custom-row"><img src="./images/present.png" alt="">
                    <p>Подарок новым участникам</p>
                </div>
                <div class="custom-row"><img src="./images/ruby.png" alt="">
                    <p>Премиальное обслуживание</p>
                </div>
                <div class="custom-row"><img src="./images/clock.png" alt="">
                    <p>Осталось 4 из 16 мест</p>
                </div>

                <div class="checkbox-container">
                    <input style="width:10%; height: 13px;" type="checkbox" class="checkbox" id="russianCheckbox" name="russianCheckbox" required="">
                    <label for="russianCheckbox">Я владею русским языком</label>
                </div>

  <div class="form-group">

    <button class="reg_btn btn secondary-solid-btn btn-block buttonSend"  name="submitBtn" type="submit">
    <p class="btnFormText" style="color:white; font-weight: 800;">Продолжить
    </p>
    </button>
  </div>
