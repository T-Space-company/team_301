...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group ">
  ...
  <label>
  Ваш номер телефона*
    <input class="form-control form-input form__input _phone" maxlength="10" placeholder="9121234567" name="phone" type="tel" />
  ...
  <div class="form-group" style="text-align: left;">
    <div style="display: flex;align-items: center;">
        ...
        <p style=" margin-left: 15px; font-size: 14px;">Я согласен с <span class="checkbox-accent">Политикой Конфиденциальности</span></p>
    </div>
