...
export function renderFormRegistrations(allFormClass) {
  ...
  const htmlFormHtml = `
 <div class="form-input-main form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control form-input form__input" name="name" placeholder="Имя" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Удалите пробелы и цифры <br> - Фамилия и имя не должны совпадать</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
</div>
  <div class="form-input-main form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control  form-input form__input" name="last_name" placeholder="Фамилия" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Удалите пробелы и цифры <br> - Фамилия и имя не должны совпадать</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
  ...
  <div class="form-input-main form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control  form-input form__input" name="email" placeholder="E-mail" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Формат test@gmail.com</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
  </div>
  
  <div class="form-input-main form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control form-input _phone"  name="phone" type="tel" style="width: 100%" required/>
    <span class="focus-input100"></span>
  </div>

  <span class="form-error-content">Неверный номер телефона</span>
  ...
  <div class="form-group container-login100-form-btn form-group-btn">
    <button class="btn secondary-solid-btn btn-block buttonSend login100-form-btn"  name="submitBtn" type="submit">
    <p class="leadSubmit buttonSend button form__btn btnFormText" style="color: #fff; text-transform: uppercase;">регистрация
    </p>
    </button>
  </div>
