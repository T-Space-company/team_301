...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group">
  ...
  <input id="name" class="form-control form-input form__input text-field w-input" style="margin-top: 8px;" name="name" placeholder="Имя" type="text" required />
  <i class="fa__err"></i>
...
<div class="form-group input-group">
  ...
  <input id="last_name" class="form-control form-input form__input text-field w-input" name="last_name" placeholder="Фамилия" type="text" required />
  <i class="fa__err"></i>
  <span class="fa__errInfo">- Удалите пробелы и/или цифры <br>- Поле не может быть пустым <br>- Имя и фамилия не должны совпадать</span>
  <i class="fa__checked"></i>
</div>
  ...
  <label for="phone" class="form-label">Ваш номер телефона*</label>
    <input id="phone" class="form-control form-input _phone" maxlength="10" placeholder="902 284 - 22 - 79" name="phone" type="tel" />
  ...
  <label class="switch">
  <input class="form-control form-input form-checkbox" type="checkbox" style="width: 16px; height: 16px" required>
  <span class="checkbox-text second">Я согласен с <span class="accent">Политикой Конфиденциальности</span></span>
  </label>
  </div>
