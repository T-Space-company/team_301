...
<html lang="en">
  <head>
    ...
    <title>Газпромбанк Трейдер</title>
  ...
  <body>
    <main class="main">
      <div class="main__top">
        <div class="top__logo">
          <img src="./assets/img/logo1.svg" alt="Logo" class="logo-1" />
          <img src="./assets/img/x.svg" alt="Divider" class="divider" />
          <img src="./assets/img/logo_main.svg" alt="Logo" class="logo-2" />
        </div>
        <p class="top__descr">
          Попробуйте свои силы в трейдинге благодаря приложению от Газпромбанк
        </p>
      </div>
      <div class="main__content">
        <div class="main__stats">
          ...
          <div class="stats__task">
            <span class="task__heading">Задача</span>
        ...
        <div class="main__form hidden" id="form-main">
          <h2 class="main__form-heading">
            Поздравляем! У вас прекрасные успехи в трейдинге! Теперь вам открыт
            доступ к платформе!
          </h2>
          <form
