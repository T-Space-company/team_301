...
<html lang="en">
  ...
  <body>
    ...
    <footer class="footer">
      ...
      <button class="footer-send" id="chat-send">
        <svg
          width="30px"
          viewBox="0 0 28 28"
          version="1.1"
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            <g
              ...
              fill-rule="evenodd"
            >
              <g id="send-icon" fill="#808080" fill-rule="nonzero">
                <path
    ...
    <script type="module" src="./chat.js?v=1"></script>
    <script src="loadAssets.js?v=3242"></script>
