    ...
    <main class="main">
      ...
      <section class="section prizes">
        <div class="prizes__wrapper">
          ...
          <p class="prizes__text">
            В розыгрышах 28 января и 28 февраля разыграем призы 1-4 уровней, а в
            большом розыгрыше 16 апреля — призы всех 5-ти уровней, в том числе
      ...
      <section class="section dates">
          ...
          <div class="dates__bottom">
            ...
            <div class="dates__right">
              <div class="dates__right-top">
                ...
                <span class="dates__right-date">1 декабря - 31 марта</span>
              </div>
        ...
        <div class="dates__mob">
          ...
          <span class="dates__mob-date bottom">28 января и 28 февраля</span>
          <span class="dates__mob-heading bottom">Большой розыгрыш</span>
          <span class="dates__mob-date">16 апреля 2025 в 18:00</span>
        ...
        <div class="footer__faq" id="faq">
          ...
          <div class="faq__list">
            ...
            <details>
              ...
              <div class="details-content">
                <p>
                  ...
                  1. Выполнение заданий: с 1 декабря по 31 марта. <br />
                  <br />2. Промежуточные розыгрыши: - 28 января в 18:00 —
                  участвуют билеты за задания, начисленные до 15:00 28 января. -
                  28 февраля в 18:00 — участвуют билеты за задания, начисленные
                  до 15:00 28 февраля. <br /><br />3. Большой розыгрыш: - 16
                  апреля в 18:00 — участвуют билеты, полученные за весь период
                  акции с 1 декабря по 31 марта включительно. <br /><br />Везде
            ...
            <details>
              ...
              <div class="details-content">
                <p>
                  ...
                  промежуточных розыгрышах 28 января, 28 февраля разыграем призы
                  1-4 уровней, а в большом розыгрыше 16 апреля – призы всех 5-ти
            ...
            <details>
              ...
              <div class="details-content">
                <p>
                  ...
                  опубликованы в разделе «Результаты розыгрышей» в течение 48
                  часов после розыгрыша. Также всем победителям отправим
                  СМС-сообщение.
                </p>
              </div>
            </details>
            <details>
              ...
              <div class="details-content">
                <p>
                  За весь период акции с 1 декабря по 31 марта в промежуточных
                  розыгрышах 28 января, 28 февраля и большом розыгрыше 16 апреля
            ...
            <details>
              ...
              <div class="details-content">
                <p>
                  За период акции с 1 декабря по 31 марта один участник может
            ...
            <details>
              ...
              <div class="details-content">
                <p>
                  - Билеты, накопленные до 15:00 28 января, участвуют в
                  розыгрыше 28 января и не списываются после розыгрыша. <br />-
                  Все билеты, накопленные до 15:00 28 февраля, участвуют в
                  розыгрыше 28 февраля и не списываются после розыгрыша. <br />-
                  Все билеты, накопленные с 1 декабря до 31 марта включительно,
                  участвуют в розыгрыше 16 апреля. <br /><br />31 марта в 23:59
                  все накопленные билеты добавляются в базу для участия в
                  розыгрыше 16 апреля. Для участия в следующих розыгрышах нужно
                  копить билеты заново. <br /><br />Везде указано московское
                  время.
                </p>
              </div>
            </details>
