 ...
 <label for="name">Ваше имя*</label>
  ...
  <div class="form-group" style="text-align: left;">
    ...
    <input style="height: 16px; width:16px;" type="checkbox" name="age_check" required>
        ...
        <p class="checkbox-text">Я согласен с <span class="accent">Политикой Конфиденциальности</p>
    </div>
    ...
    <div style="display: flex;align-items: center;">
        ...
        <p class="checkbox-text">Я подтверждаю, что являюсь совершеннолетним гражданином РФ</p>
    </div>
