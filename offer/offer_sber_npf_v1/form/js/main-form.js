...
const sourceValue = getQueryParam("crm_source") || infoElems[12] || "unparsed";

let buyerValue = getQueryParam("buy_id");

if (!buyerValue) {
    buyerValue = (infoElems[0] && !/info/i.test(infoElems[0])) ? infoElems[0] : "002";
}
...
const crmSourceEvent = getQueryParam("crm_source");
