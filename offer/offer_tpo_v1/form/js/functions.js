...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group ">
    <input class="form-control form-input form__input" name="name" placeholder="İsim"  type="text" />
    <i class="fa__err"></i>
  ...
  <div class="form-group input-group ">
    <input class="form-control  form-input form__input" name="last_name" placeholder="Soyadı"  type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve/veya sayıları kaldırın <br>- Uzay boş olamaz <br> - Ad ve soyad eşleşemez</span>
    <i class="fa__checked"></i>
  </div>
  ...
  <div class="form-group">
    ...
    <p class="btnFormText" style="color:white; font-weight: 800;">Kayıt
    </p>
    </button>
  </div>
