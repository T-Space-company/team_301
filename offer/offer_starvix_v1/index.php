...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="./css/main.css?v=453453435" />
    ...
    <noscript>
      <div>
        <img
          src="https://mc.yandex.ru/watch/102052856"
  ...
  <body>
    <header>
      ...
      <nav>
        <div style="display: flex; align-items: center">
          <a href="#contact">
            <img style="width: 50px" src="logo-1.png" alt="logo" />
          </a>
          <h4>Starvix</h4>
        </div>
        <ul class="nav__list">
      ...
      <div class="header__wrapper">
        <div class="header__cnt">
          <h1>
            <span class="h_t">Бесплатно</span><span class="dot-m">,</span>
            <span class="h_m"
              >расскажем, как зарабатывать на крипте от 100$ в день</span
            >
          </h1>
          <p class="header__afterTitle">Даже если ты новичок</p>
          <a href="#contact" class="nav__link nav__link-w">Подать заявку</a>
        </div>
        <img src="./img/layer_new.png" class="header__layer" alt="layer" />
      </div>
    </header>
    <main>
      ...
      <section class="about" id="about">
        <div class="about__wrapper">
          <img src="./img/layer2_new.png" alt="" class="aboutImg" />
    ...
    <script src="loadAssets.js?v=345345"></script>
    <script
