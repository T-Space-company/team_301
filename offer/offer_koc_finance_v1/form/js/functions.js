...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="input--wrapper form-input-main form-group input-group wrap-input100 m-b-26">
    <input class="form--input input100 form-control form-input form__input" name="name" placeholder="İlk İsim" required type="text" />
    <i class="fa__err"></i>
  ...
  <div class="input--wrapper form-input-main form-group input-group wrap-input100 m-b-26">
    <input class="form--input input100 form-control  form-input form__input" name="last_name" placeholder="Soyadı" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve sayıları kaldırın <br> - Soyadı ve adı aynı olmamalıdır</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
  ...
  <div class=" form-group container-login100-form-btn form-group-btn">
    ...
    <p class=" button form__btn btnFormText" style="text-transform: uppercase;">Kayıt Olun
    </p>
    </button>
  </div>
