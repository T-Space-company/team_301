    ...
    t_formsApi__clearForm = _async$1((function(t) {
        return _catch$1((function() {
            ...
            var e = t.closest(".t-rec"),
                r, o = Array.from(t.querySelectorAll(".t-input-group")).map(t_formsApi__initTildaField);
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
        ...
        for (var e = t_forms__getElement(t), r = e.querySelectorAll(".js-tilda-rule"), o = [], n = !0, a = e.getAttribute("data-formcart"), i, s = t_forms__getConditionCheckHandler(e).isHiddenByCondition, l = 0; l < r.length; l++) {
            ...
            if (!s(c)) {
                var u = !!parseInt(c.getAttribute("data-tilda-req") || 0, 10),
                    ...
                    m, f, _ = c.getAttribute("data-tilda-rule-minlength") || 0,
                    ...
                    switch (d) {
                        ...
                        case "time":
                            m = /^[0-9]{2}[:\.][0-9]{2}$/gi, //! TODO: 00:00 - 23:59. Заменить на /^([0-1][0-9]|2[0-3])[:\.][0-5][0-9]$/gi
                                v.length > 0 && !v.match(m) && w.type.push("time");
                            break;
                        case "name":
        ...
        if (d) {
            ...
            if (Array.prototype.forEach.call(h, (function(t) {
                ...
                if (g && g.length) {
                    var b, E = '.t1093 .t-popup[data-tooltip-hook="' + g[g.length - 1] + '"]',
...
function t_forms__onSuccess(t) {
    ...
    var e = t_forms__getElement(t),
        ...
        f, _ = window.innerHeight,
        p = document.body,
        w = document.documentElement,
        y = Math.max(p.scrollHeight, p.offsetHeight, w.clientHeight, w.scrollHeight, w.offsetHeight);
    if (121 == o) {
...
function t_forms__handleRedirect(t, e, r) {
    ...
    if (t_forms__isNewSuccessBox(t)) {
        ...
        function f(t) {
            var e = document.querySelector(".t-form-success-popup__info-digit"),
                r = t / 1e3;
            e.textContent = r;
...
function t_forms__isNewSuccessBox(t) {
    return !!t && (!!t_forms__isTeam() && (!t_forms__isQuiz(t) && !["t396", "t447", "t651", "t653", "t706", "t708", "t945", "t1122"].some((function(e) {
        return t.closest("." + e)
    }))));
    var e, r
}
...
function t_forms__processFormsInPopup(t, e) {
    ...
    var n, a = "t" + e.closest(".t-rec").getAttribute("data-record-type") + "_closePopup",
