...
function t_form_phonemask_init(e, t, n, a) {
    var o, p = (a || {}).multiple,
        r, i = void 0 !== p && p ? t_form_phonemask__multiple__initPhoneMaskForm : t_form_phonemask_initPhoneMaskForm,
        s = n;
    if (s && "undefined" !== s) i(e, t, s);
        ...
        m.open("GET", "https://geo.tildacdn.com/geo/country/", !0), m.onreadystatechange = function() {
            if (4 === m.readyState)
        ...
        }, m.send(), window.geoCountryRequested = !0
    }
}
    ...
    if (a) {
        ...
        if (o && !o.getAttribute("data-init-mask")) {
            ...
            t_form_phonemask__saveISOtoLocalStorage(p.iso), t_form_phonemask__prepareInputGroup({
                ...
                countryConfig: p,
                lid: t
            }), t_form_phonemask__triggerInitMask(o), t_form_phonemask__initResetListener(o, p)
        }
    }
}
...
function t_form_phonemask__replaceInput(e) {
    ...
    if (t) {
        ...
        m || ((m = document.createElement("div")).classList.add("t-input-phonemask__options-wrap"), m.setAttribute("data-nosnippet", ""), document.body.append(m)), 0 !== s.length && Array.prototype.forEach.call(s, (function(e) {
            t_remove(e)
        }))
    }
}
...
function t_form_phonemask__prepareInputGroup(e) {
    ...
    if (s) {
        ...
        l.setAttribute("data-phonemask-flag", p), x.innerHTML = c, t_form_phonemask__changeMinLength(u, c, t), t_form_phonemask__addCurrentStyle(t), t_form_phonemask__initSelectEvents(o, t, r)
    }
}
...
function t_form_phonemask__preparePhoneMaskInput(e, t) {
    ...
    return e.setAttribute("id", "input_" + o), e.setAttribute("data-phonemask-iso", n), e.setAttribute("data-phonemask-code", p), e.setAttribute("data-phonemask-mask", r), e.setAttribute("placeholder", i), t_form_phonemask__calcMaxlength(e), {
        code: p,
        mask: r,
        placeholder: i
    }
...
function t_form_phonemask__initResetListener(e, t) {
    e.addEventListener("reset", (function() {
        t_form_phonemask__setValue(e, "", t.iso, {
            silent: !0,
            noFocus: !0
        })
    }))
...
function t_form_phonemask__initSelectEvents(e, t, n) {
    ...
    function b() {
        u(), x(), l(), f(), h() ? _() : (p.style.position = "", g())
    }
    ...
    function A(e) {
        ...
        if (t) {
            ...
            var x = /^[a-zA-Z]$/.test(e.key),
                d = /^[а-яА-Я]$/.test(e.key);
            if (x || d) {
                s = (s += e.key).replace(a, "\\$&");
                var _ = new RegExp("(^|\\()" + s, "i");
                for (var h in n) t_form_phonemask__searchCountry(t, _, p, h, n[h].n);
                t_form_phonemask__scrollToCountry(t, p), c()
            }
        }
    }
    t_form_phonemask__changeVal(t, a), o.addEventListener("click", y), a.addEventListener("paste", (function(e) {
        var t = (e.clipboardData || window.clipboardData).getData("text");
        if (t) {
            t = t.replace(/[^0-9+]/g, "");
            var n = e.target;
            n && (n.value = t, w.call(n), n.dispatchEvent(new Event("change", {
                bubbles: !0
            })), e.preventDefault())
        }
    })), a.addEventListener("input", w), document.addEventListener("mouseup", C), document.addEventListener("keyup", A), document.querySelector('[data-init-mask="yes"]') || (document.addEventListener("mouseup", C), document.addEventListener("keyup", A))
}
...
function t_form_phonemask__setValue(e, t, n, a) {
    if (e) {
        ...
        if (o) {
            ...
            var x = e.querySelector('[name="tildaspec-phone-part[]"]');
            x && (x.value = t, t_form_phonemask__calcMaxlength(x), t_form_phonemask__handleChangeInputValue(e, x))
        }
    }
}

function t_form_phonemask__removeCountryCodeFromValue(e, t) {
    return e && t && e.startsWith(t) ? e.substring(t.length).trim() : e
}
...
function t_form_phonemask__handleUpdateCountry(e, t) {
    ...
    c && t_form_phonemask__addNumberMask(c, i), t_form_phonemask__changeVal(e, i), t_form_phonemask__changeMinLength(u, n, e), p || i.focus(), r || i.dispatchEvent(new Event("change", {
        bubbles: !0
    }))
}
...
function t_form_phonemask__handleChangeInputValue(e, t) {
    ...
    var a = "+7" === t.getAttribute("data-phonemask-code"),
        ...
        p;
    a && o && (t.value = n.replace(/^.(8|7)9/, "9")), t_form_phonemask__addNumberMask(t_form_phonemask__copypasteHandling(t, t.getAttribute("data-phonemask-without-code")), t), t_form_phonemask__changeVal(e, t), t.setAttribute("data-phonemask-current", t.value)
}
...
function t_form_phonemask__changeMinLength(e, t, n) {
    var a = n.querySelector(".js-phonemask-result"),
        o, p = t_form_phonemask__getMinMaxLength(e, t).minLength;
...
function t_form_phonemask__validatePhone(e) {
    ...
    if (!a) return !1;
    var o, p = t_form_phonemask__getCountriesList()[a];
    if (!p) return !1;
    var r = p.c,
        i, s, m, c = "+ " + n,
