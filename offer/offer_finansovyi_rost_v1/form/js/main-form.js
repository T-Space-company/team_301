...
const settingObjForm = {
  postParams: {
    ...
    _setParams: function (answers) {
      ...
      this.slug = "301";
      this.source = "iron";
      this.utm_medium = "98b55d30-ac9c-41c9-8298-821d1ea962df";
...
const postData = async (data) => {
  ...
  try {
    ...
    if (result?.success === true) {
      ...
      let postbackUrl = `postback_handler.php?dynamicParameter=${infoElems[4]}&appId=${infoElems[5]}`;

      fetch(postbackUrl, {
        method: "GET", // Мы используем GET, чтобы передать параметры в URL
      }).finally(() => {
