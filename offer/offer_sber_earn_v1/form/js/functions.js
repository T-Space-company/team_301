...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-wrapper">
  <div class="main__section-form-fields">
    <div class="form-group input-group main__section-form-field">
      <input
      ...
      <span class="fa__errInfo"
        >- Удалите пробелы и/или цифры <br />- Поле не может быть пустым <br />
    ...
    <div class="form-group input-group main__section-form-field ">
      <input
        class="form-control form-input _phone main__section-form-phone-input"
        maxlength="10"
  ...
  <div class="main__section-form-inputs form-group input-group">
    <div class="main__section-form-input">
      <input type="checkbox" name="age" id="age" required/>
      <label for="age">Я старше 21 года</label>
    </div>
    <div class="main__section-form-input">
      <input type="checkbox" name="country" id="country" reqired/>
      <label for="country">Я гражданин Российской Федерации</label>
    </div>
  </div>
  ...
  <div class="form-group form-button-wrapper">
    <button
      class="main__section-form-button btn secondary-solid-btn btn-block buttonSend"
      name="submitBtn"
      type="submit"
    >
      <p class="btnFormText" style="color: white; font-weight: 800">
        Оставить заявку
      </p>
    </button>
  </div>
