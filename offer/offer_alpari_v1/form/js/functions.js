...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group form-field">
  ...
  <div class="form-group">
    ...
    <button class="btn secondary-solid-btn btn-block buttonSend buttonFormSend"  name="submitBtn" type="submit">
    <p class="btnFormText buttonFormText" style="color:white; font-weight: 600;">Завершить регистрацию
    </p>
    </button>
  </div>
