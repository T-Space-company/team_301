document.addEventListener("DOMContentLoaded", () => {
  ...
  const firstMessages = [
    `Пройдите официальный тест от “ООО Альпари-Брокер” и получите доступ к платформе!`,
    "Поздравляю! Теперь от “ООО Альпари-Брокер” для Вас открыта возможность зарабатывать на акциях российских и зарубежных компаний и получать от 87 000 ₽ уже с первых недель!",
  ...
  function createRevenueButtons() {
    ...
    const handleEarnFirst = () => {
      ...
      createMessage(
        "Спасибо за уделённое время и пройденный опрос! Теперь Вам открыт доступ к персональной платформе проекта “ООО Альпари-Брокер”"
      );
      createMessage(
