...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control form-input form__input" name="name" placeholder="Adınız" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve sayıları kaldırın <br> - Soyadı ve adı aynı olmamalıdır</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
</div>
  <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control  form-input form__input" name="last_name" placeholder="Soyadınız" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve sayıları kaldırın <br> - Soyadı ve adı aynı olmamalıdır</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
  ...
  <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control  form-input form__input" name="email" placeholder="E-posta" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Biçim test@gmail.com</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
  </div>
  ...
  <span class="form-error-content">Yanlış telefon numarası</span>
  ...
  <div class="form-group container-login100-form-btn">
    <button class="btn secondary-solid-btn btn-block buttonSend login100-form-btn" style="background-color: #ec0001;" name="submitBtn" type="submit">
    <p class="btnFormText" style="color: #fff; text-transform: uppercase;">ücretsiz kayıt
    </p>
    </button>
  </div>
