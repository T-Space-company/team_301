...
Ваша фамилия*
    ...
    <i class="fa__checked"></i>
     ...
     <div class="form-group input-group">
  <label class="form-label" for="contact-method">Выберите способ связи*
  <select id="contact-method" name="contact-method" class="form-control form-input form__input" required>
...
Ваш номер телефона*
  ...
  <div class="form-group form-group-button">
    ...
    <p class="btnFormText">Начать зарабатывать</p>
    </button>
  </div>
