...
<div class="form-group input-group ">
  <label for="name" class="form-label">Ваше имя*</label>
    <input class="form-control form-input form__input text-field w-input" style="margin-top: 8px;" name="name" placeholder="Ваше имя"  type="text" required />
    <i class="fa__err"></i>
  ...
  <div class="form-group input-group ">
    ...
    <input class="form-control  form-input form__input text-field w-input" name="last_name" placeholder="Ваша фамилия" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Удалите цифры </span>
    <i class="fa__checked"></i>
    </div>
