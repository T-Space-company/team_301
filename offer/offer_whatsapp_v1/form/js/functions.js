...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group wrap-input100 m-b-26">
  ...
  <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control  form-input form__input" name="email" placeholder="Почта" required type="text" />
    <i class="fa__err"></i>
  ...
  <div class="form-group container-login100-form-btn">
    <button class="btn secondary-solid-btn btn-block buttonSend login100-form-btn" style="background-color: var(--green)" name="submitBtn" type="submit">
    <p class="leadSubmit buttonSend button form__btn btnFormText" style="color: #fff; text-transform: uppercase;">Оставить заявку
    </p>
    </button>
  </div>
