...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control form-input form__input" name="name" placeholder="İsminizi giriniz." required type="text" />
    <i class="fa__err"></i>
  ...
  <div class="form-group input-group wrap-input100 m-b-26">
    <input class="input100 form-control  form-input form__input" name="last_name" placeholder="Soyisminizi giriniz." required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Boşlukları ve/veya sayıları kaldırın <br>- Uzay boş olamaz <br> - Ad ve soyad eşleşemez</span>
    <i class="fa__checked"></i>
    <span class="focus-input100"></span>
  ...
  <div class="form-group container-login100-form-btn">
    ...
    <p class="btnFormText">BAŞVURUMU GÖNDER
    </p>
    </button>
  </div>
