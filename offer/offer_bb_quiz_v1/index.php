    ...
    <main class="main">
      ...
      <div class="main__wrapper">
        <div class="main__heading-wrapper">
          <h2 class="main__heading">Зарабатывайте вместе с BYBIT</h2>
          <span class="main__subheading">от 300 000 ₽</span>
        </div>
        <!-- <ul class="main__content">
          <li class="content__item">
            <span class="accent">Bybit приносит:</span>
          </li>
          <li class="content__item">
        ...
        <span class="main__info">Минимальный вклад - 10 000 ₽</span>
        <ul class="main__list">
          <li class="list__item">Проверено тысячами участников!</li>
          <li class="list__item">Вывод доступен с первого дня</li>
          <li class="list__item">
            Минимальный депозит на старте и первый заработок уже в день
            регистрации
          </li>
        </ul>
      </div>
      ...
      <div class="screen__wrapper hidden">
        <div class="screen main__intro hidden" id="quiz-intro">
          <div class="modal__content quiz">
            ...
            <div class="modal__info">
              <span class="info__text">Получите</span>
              <span class="info__text accent">до 1 000 USD₮</span>
              <span class="info__text"
                >для торговли на счет биржи от Bybit</span
              >
            </div>
            <button type="button" class="quiz__item start">
              Получить бонус
            </button>
          </div>
        </div>
        <div class="screen main__ticket hidden" id="quiz-ticket">
          <div class="modal__content quiz ticket">
            <div class="modal__heading ticket">
              <img src="./assets/img/logo.svg" alt="Logo" />
            </div>
            <img src="./assets/img/gift.png" alt="Image" class="modal__image" />

            <div class="modal__info ticket">
              <span class="info__text">Ваш бонус</span>
              <span class="info__text accent ticket">50 USD₮</span>
              <span class="info__text">для торговли</span>
            </div>
            <div class="modal__ticket">
              <img src="./assets/img/line.svg" alt="Image" />
            </div>
            <span class="modal__subheading">Чтобы получить</span>
            <ul class="modal__list">
              <li class="modal__item">Пройдите короткий опрос</li>
