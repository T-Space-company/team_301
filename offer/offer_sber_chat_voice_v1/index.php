  ...
  <body>
    <header class="header">
      <div class="header-container">
        <div class="header--left">
          <img src="./img/icons/back.svg" alt="Icon" />
        </div>
    ...
    <main class="main">
      ...
      <div class="main-messages">
        <div class="messages__start" id="start-block">
          <button type="button" class="messages__button" id="start-btn">
    ...
    <script src="loadAssets.js?v=541"></script>
