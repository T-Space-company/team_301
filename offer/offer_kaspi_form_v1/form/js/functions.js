...
export function renderFormRegistrations(allFormClass) {
 ...
 <label for="name">Ваше имя*</label>
  ...
  <label for="name">Ваш номер телефона*</label>
    <input class="form-control form-input _phone" maxlength="10" placeholder="902 284 - 222 - 34" name="phone" type="tel" />
    <div class="error-phone"></div>
  </div>
  
  
  
  <div class="form-group input-group group-checkbox m-top">
    <label class="switch">
    <input class="form-input form-checkbox" type="checkbox" required>
    </label>
    <span class="checkbox-text">Я согласен с политикой конфиденциальности</span>
  </div>
  ...
  <div class="form-group input-group group-checkbox">
    ...
    <span class="checkbox-text">Подтверждаю пользовательское соглашение</span>
  </div>
  ...
  <span class="checkbox-text">Я подтверждаю, что я совершеннолетний гражданин Казахстана</span>
</div>
