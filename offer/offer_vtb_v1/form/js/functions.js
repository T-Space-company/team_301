...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group ">
  ...
  <span class="checkbox-text">Я старше 21 года</span>
</div>
  ...
  <span class="checkbox-text">Я гражданин Российской Федерации</span>
</div>
  ...
  <div class="form-group form-group-button">
    ...
    <p class="btnFormText" style="color:white;">Отправить заявку
    </p>
    </button>
  </div>
