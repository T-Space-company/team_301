  ...
  <body>
    ...
    <main class="main">
      <section class="main__section">
        <div class="main__section-headings">
          <h1>Спасибо за регистрацию!</h1>
          <h2>Ответьте на звонок менеджера, чтобы забрать ваш бонус</h2>
          <div class="timer"></div>
        </div>
        <div class="main__section__content">
          <div class="main__section__content-title">
            <span>Что наши клиенты говорят о нас</span>
          </div>
          <div class="main__section-content-reviews">
            <div class="main__section-content-review">
              ...
              <div class="main__section-content-review-avatar">
                ...
                <div class="main__section-content-review-avatar-name">
                  ...
                  <img src="./img/icons/stars.svg" alt="Stars" />
                </div>
              </div>
            </div>
            <div class="main__section-content-review">
            ...
            <div class="main__section-content-review">
              ...
              <div class="main__section-content-review-avatar">
                <img src="./img/avatars/Pic-4.png" width="30px" alt="" />
                <div class="main__section-content-review-avatar-name">
            ...
            <div class="main__section-content-review">
              ...
              <div class="main__section-content-review-avatar">
                <img src="./img/avatars/Pic-5.png" width="30px" alt="" />
                <div class="main__section-content-review-avatar-name">
