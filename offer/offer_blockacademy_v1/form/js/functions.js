...
<label class="input-label field__title">
  ...
  <div class="checkbox-wrap">
     ...
     <span class="checkbox-descr">Соглашаюсь на обработку персональных данных в соответствии с <a href="./policy.pdf" target="_blank" class="accent">Политикой конфиденциальности</a></span>
  </label>
  </div>
