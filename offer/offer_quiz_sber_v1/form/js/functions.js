...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group">
    ...
    <input class="form-control form-input form__input text-field" name="name" placeholder=""  type="text" required />
    <i class="fa__err"></i>
  ...
  <div class="form-group input-group ">
  <label for="name" class="field-label">Введите фамилию</label>
    <input class="form-control  form-input form__input text-field" name="last_name" placeholder="" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Удалите пробелы и/или цифры <br>- Поле не может быть пустым <br> - Имя и фамилия не должны совпадать</span>
    <i class="fa__checked"></i>
    </div>
  ...
  <label for="Phone" class="field-label">Введите телефон</label>
    <input class="form-control form-input _phone text-field" maxlength="10" placeholder="912 345-67" name="phone" type="tel" />
  ...
  <label class="switch w-checkbox checkbox-field">
  <input class="form-control form-input form-checkbox" type="checkbox" style="width: 13px; height: 13px" required>
  <span class="checkbox-text checkbox-label w-form-label">Я подтверждаю, что мне есть 18</span>
