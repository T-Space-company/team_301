...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group ">
  ...
  <span class="checkbox-text second">Подтверждаю, что являюсь гражданином Российской Федерации</span>
  <label class="switch">
  <input class="form-control form-input form-checkbox" type="checkbox" required>
  <span class="slider round"></span>
  </label>
  ...
  <div class="form-group">
    ...
    <p class="btnFormText" style="color:white; font-weight: 800;">Отправить заявку
    </p>
    </button>
  </div>
