    ...
    <main class="main">
      ...
      <div class="main__intro" id="first-screen">
        ...
        <div class="intro__content">
          ...
          <div class="intro__stocks">
            <img src="./assets/img/stocks.png" alt="Image" />
          </div>
          <div class="intro__wheel-wrap">
            <div class="wheel__border">
              <img src="./assets/img/wheel.png" alt="Image" />
            </div>
            <div class="wheel__content-wrap">
              <div class="wheel__content">
                <img src="./assets/img/wheel-content.png" alt="Image" />
              </div>
            </div>
          </div>
          <button type="button" class="intro__button" id="start-btn">
            Крутить колесо <img src="./assets/img/arrow.svg" alt="Icon" />
          </button>
        </div>
      </div>
      <!--------- SCREEN 2 --------->
      <div class="main__prize hidden" id="second-screen">
        <div class="prize__wrapper">
          <div class="prize__item-wrap">
            <div class="prize__item">
              <img src="./assets/img/stock.png" alt="Image" />
            </div>
          </div>
          <span class="prize__heading">Поздравляем!</span>
          <p class="prize__text">
            Вы выиграли <b>23 акций</b> на сумму <b>22 523 рублей!</b>
          </p>
