  ...
  <body>
      ...
      <div class="pattern-bg">
        <div class="header">
          <div class="header__row">
            <img class="header__left" src="./images/back.svg" alt="" />
            <div class="header__center">
              <img class="header__logo-icon" src="./images/logo.jpg" alt="" />
              <div class="header__info">
                <p class="header__logo-title">ГАЗПРОМ</p>
                <p class="header__text-online">в сети</p>
              </div>
              <img
                class="header__icon-verified"
                src="./images/verified.svg"
                alt=""
              />
            </div>
            <img class="header__right" src="./images/phone.svg" alt="" />
          </div>
        </div>
        <div class="main-chat">
    ...
    <div id="modal-1" class="modal">
      ...
      <div class="modal__header">
        <img src="./images/logo_first.svg" alt="Logo" />
        <img src="./images/rf.svg" alt="Logo" />
      </div>
      <div class="modal__content">
        <span class="modal__heading">Добрый день!</span>
        <p class="modal__descr">
          ГазпромИнвест подготовил для Вас подарок В виде 20 акций
        </p>
        <span class="modal__heading bottom">Подарок</span>
        <button type="button" class="modal__button" id="modal-1-btn">
          Узнать детали
        </button>
        <img src="./images/gift.png" alt="Image" class="modal__image" />
      </div>
    </div>
    ...
    <div id="modal-2" class="modal hidden">
      ...
      <div class="modal__content second">
        <p class="modal__descr">Зарабатывайте вместе с ГазпромИнвест</p>
        <span class="modal__heading">от 250 000₽</span>
        <img
          src="./images/modal_second.png"
          alt="Image"
          class="modal__image second"
        />
        <div class="modal__list">
          <span class="modal__item">Минимальный вклад от - 10 000₽</span>
          <span class="modal__item"
            >Станьте микроинвестором и успейте забрать как можно больше в
            ГазпромИнвест
          </span>
          <span class="modal__item"
