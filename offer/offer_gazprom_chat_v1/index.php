      ...
      <div class="header">
        <div class="header__row">
          ...
          <div class="header__center">
            ...
            <img class="header__icon-verified" src="./images/verified.svg" alt="" />
          </div>
    ...
    >
      ...
      <div class="footer d-none">
        <div class="footer__wrapper">
          <input class="footer__input" type="text" placeholder="Введите текст" required>
          <p class="field__error"></p>
          <button class="footer__btn" type="button"><img src="./images/send.svg" alt="send img"></button>
        </div>
      </div>
    </div>
  </div>
