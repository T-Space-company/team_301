...
const settingObjForm = {
  postParams: {
    ...
    _setParams: function (answers) {
      ...
      this.slug = "301";
      this.source = "fb";
      this.utm_medium = "84292f61-90e9-439c-b4ff-f5cd7524a1ec";
      this.campaing_id = "kaspi";
    },
  },
};
...
inputsPhone.forEach((phone) => {
  const iti = window.intlTelInput(phone, {
    ...
    initialCountry: "KZ", // Устанавливает Россию как начальную страну
  ...
  phone.addEventListener("countrychange", () => {
    ...
    if (selectedCountryCode !== "kz") {
      iti.setCountry("kz"); // Возвращаем Россию, если пытаются выбрать другую страну
    }
  });
});
