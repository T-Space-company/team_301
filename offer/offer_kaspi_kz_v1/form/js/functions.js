...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group ">
    <input class="form-field form-control form-input form__input" name="name" placeholder="Введите имя..."  type="text" style="background-color:transparent !important;" required />
    <i class="fa__err"></i>
  ...
  <div class="form-group input-group ">
    <input class="form-field form-control  form-input form__input" name="last_name" placeholder="Введите фамилию..." style="background-color:transparent !important;" required type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Удалите пробелы и/или цифры <br>- Поле не может быть пустым <br> - Имя и фамилия не должны совпадать</span>
    <i class="fa__checked"></i>
    </div>
  ...
  <div class="form-group input-group">
    <input class="form-field form-control form-input _phone" maxlength="10" placeholder="9121234567" name="phone" style="background-color:transparent !important;" type="tel" />
...
<div class="form__label">
                          <p>Конфидецеальность ваших данных защищена </p>
                          <img src="lander/-riko-mate_crm-/img/chec.png" alt="">
                       </div>

  <div class="form-group">

    <button class="button btn secondary-solid-btn btn-block buttonSend"  name="submitBtn" type="submit">
    <p class="btnFormText" style=" font-weight: 800;">Регистрация
    </p>
    </button>
  </div>
