...
<label class="input-label">
  ...
  <div class="form-group form-group-button">
    ...
    <p class="btnFormText">Результаты
    </p>
    </button>
  </div>
 ...
 <div class="form-group input-group group-checkbox">
  ...
  <input type="checkbox" id="check-23" required/>
  ...
  <span class="checkbox-text">Я соглашаюсь на <span class="input-accent">обработку персональных данных </span>согласно <span class="input-accent">политике конфиденциальности</span></span>
</div>
