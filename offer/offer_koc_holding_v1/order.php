...
$leads_data = 'https://' . $_SERVER['HTTP_HOST'] . '/33157d8/postback?subid=' . $_COOKIE['subid'] . '&status=lead&sub_id_20=' . $post_data['name'] . '&sub_id_21=' . $post_data['surname'] . '&sub_id_23=' . $post_data['phoneNumber'] . '&sub_id_24=' . $post_data['status'] . '&sub_id_25=' . 'New Lead'; 
