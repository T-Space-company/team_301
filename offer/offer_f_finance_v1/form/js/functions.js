...
<span class="checkbox-text">Даю согласие на обработку персональных данных в соответствии c <span class="policy-privacy">Политикой конфиденциальности</span></span>
</div>
  ...
  <div class="form-group">
    ...
    <p class="btnFormText" style="color:white; font-weight: 800;">Зарегистрироваться
    </p>
    </button>
  </div>
