...
<div class="form-group input-group ">
  ...
  <div class="form-group form-group-button">
    ...
    <p class="btnFormText">Записаться на курс</p>
    </button>
  </div>

  <div class="form-group form-text-wrap">
  <span class="form-text">Нажимая на кнопку, я соглашаюсь на <span class="accent">обработку персональных данных</span>, с <span class="accent">правилами пользования Платформой</span> и <span class="accent">публичной офертой</span>, правилами акций
<span class="accent">«Поможем найти работу или вернем деньги»</span> и <span class="accent">«Учись сейчас - плати потом»</span></span>
  </div>

  <div class="form-group input-group group-checkbox">
  <input class="form-input form-checkbox" type="checkbox" required>
  <span class="checkbox-text">Я согласен получать рекламу и звонки</span>
  </div>
  <div class="form-group input-group group-checkbox">
  <input class="form-input form-checkbox" type="checkbox" required>
