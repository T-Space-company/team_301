...
<div class="form-group input-group ">
  ...
  <input id="checkbox-1" class="form-input form-checkbox" type="checkbox" name="checkbox-1" required>
  <label class="switch" for="checkbox-1">  
    <span class="slider round"></span>
  </label>
  <span class="checkbox-text">Подтверждаю что мой возраст более 25 лет</span>
</div>


  <div class="form-group input-group group-checkbox">
  <input id="checkbox-2" class="form-input form-checkbox" type="checkbox" name="checkbox-2" required>
  <label class="switch" for="checkbox-2">  
    <span class="slider round"></span>
  </label>
  <span class="checkbox-text">Подтверждаю что являюсь гражданином Российской Федерации</span>
</div>
