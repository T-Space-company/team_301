    ...
    <main class="main first">
      ...
      <div id="modal" class="modal">
        <div class="modal__content">
          <p class="modal__question">Вам есть 21 год?</p>
      ...
      <div id="modal-3" class="modal hidden">
        <div class="modal__content">
          <p class="modal__question">
            Готовы вложить 10 000 ₽ и получить бонус +5 000 ₽ для торговли с
            нашим ботом?
          </p>
          <div class="modal__actions">
            <button
      ...
      <div id="modal-4" class="modal hidden">
        <div class="modal__content">
          <p class="modal__question">
            Сейчас у вас есть демо-счёт на 15 000 ₽. Попробуйте сделать 4 сделки
            с нашим интеллектуальным ботом. Следуйте его рекомендациям и
            зарабатывайте!
          </p>
          <div class="modal__actions">
            <button class="modal__button--first" id="quiz4-btn">Начать</button>
          </div>
        </div>
      </div>
      <!--------- FINAL MODAL --------->
      <div id="modal-5" class="modal hidden">
        <div class="modal__content">
          <h2 class="modal__heading">Оставьте заявку прямо сейчас!</h2>
          <div class="modal__balance">
            <span class="modal__balance-heading">Ваш текущий баланс</span>
            <span class="modal__balance-sum">25 598 ₽</span>
          </div>
          <p class="modal__question">
            Наш персональный менеджер свяжется с вами, чтобы активировать
            торгового бота и помочь вам сделать первый депозит.
          </p>
          <p class="modal__text">
            Вложите 10 000 ₽, и моментально получите ещё 5 000 ₽ бонусом для
            торговли! Удваивайте свой стартовый капитал и зарабатывайте уже
            сегодня!
          </p>
          <div class="modal__actions">
            <button class="modal__button--first" id="quiz5-btn">
              Оставить заявку
            </button>
          </div>
          <h2 class="modal__heading">При поддержке</h2>
          <div class="modal__partners">
            <img src="./assets/img/sb.svg" alt="Icon" />
            <img src="./assets/img/CBRF.svg" alt="Icon" />
            <img src="./assets/img/mf.svg" alt="Icon" />
          </div>
        </div>
      </div>
      <!--------- FORM MODAL --------->
            ...
            >
              <div class="text-block-6">
                <h2 class="form-heading" style="text-align: center">
                  <span class="heading-accent">Пройдите регистрацию</span>
                  <br />
