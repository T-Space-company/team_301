...
<html lang="en">
  <head>
    ...
    <?php
      file_get_contents('https://' . $_SERVER['HTTP_HOST'] . '/fd5b7ed/postback?subid=' . $_COOKIE['subid'] . '&status=lead');
    ?>
...
button:hover {
  ...
  <div class="contentAlert">
    ...
    <div class="bottomHalf">
      ...
      <p>Вас перенаправляет в личный кабинет инвестиционной платформы</p>
  ...
  <script>
    ...
    for (var i = 0; i < cookies.length; i++) {
      ...
      if (cookie.indexOf("auto_link=") == 0) {
        auto_link = cookie.substring("auto_link=".length, cookie.length);
        break;
      }
    }
    setTimeout(() => {
