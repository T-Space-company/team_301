...
<body>
    <header class="header">
      <div class="header__content">
        ...
        <div class="header__right">
          ...
          <button class="header_button-lang"><a href="./thankyou-page.php">ENG</a></button>
    ...
    <main class="main">
      <section class="section hero">
        <div class="thankyou_hero__wrapper">
          <div class="hero__left thankyou_hero">
            <h1>
              Thanks for the
 <br> application!
            </h1>
            <div class="hero__text">
              <span>Your personal manager will be in touch with you shortly</span>
            </div>
          </div>
          <div class="hero__right">
            <img src="./img/subhero-4.png" alt="Cover" class="img-container" />
          </div>
        </div>
      </section>
    </main>
